...
public class AwareInterfaces implements ApplicationContextAware,
	...
	public void setEnvironment(Environment env) {
		...
		System.out.println("setEnvironment::ENV.getActiveProfiles="+Arrays.toString(env.getActiveProfiles()));
	}
